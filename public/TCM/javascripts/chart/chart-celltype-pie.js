...
// Pie Chart Example
var ctx = document.getElementById("CellTypePieChart");
var myPieChart = new Chart(ctx, {
  type: "pie",
  data: {
      labels: ["CD4", "Tgd",   "NKT", "CD8", "Proliferative", "MAIT"],
    datasets: [
      {
          data: [0.559, 0.006, 0.013, 0.358,  0.045, 0.021],
          cellnumber: [171761, 1824,  3875, 110218, 13838, 6532],
        backgroundColor: [color4, color5, color6, color7, color1],

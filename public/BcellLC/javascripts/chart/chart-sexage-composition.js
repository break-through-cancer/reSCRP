...
// Pie Chart Example
var ctx = document.getElementById("SAComp");
var myPieChart = new Chart(ctx, {
    type: "pie",
    data: {
        labels: ["Female & age <= 65", "Female & age > 65", "Male & age <= 65", "Male & age > 65"],
        datasets: [
            {
                data: [0.187538217, 0.267355591, 0.279646162, 0.26546003],
                cellnumber: [9201, 13117, 13720, 13024],

...
// Pie Chart Example
var ctx = document.getElementById("TissueComp");
var myPieChart = new Chart(ctx, {
  type: "pie",
  data: {
    labels: ["Distant", "Intermediate", "Adjacent", "Tumor"],
    datasets: [
      {
          data: [0.053361053, 0.056275733, 0.049977579, 0.840385635],
        cellnumber: [2618, 2761, 2452, 41231],

...
// Pie Chart Example
var ctx = document.getElementById("DriverComp");
var myPieChart = new Chart(ctx, {
    type: "pie",
    data: {
        labels: ["KRAS", "EGFR", "Other"],
        datasets: [
            {
                data: [0.164404223, 0.215543598, 0.620052179],
                cellnumber: [8066, 10575, 30421],
                backgroundColor: [color4, color5, color6],

...
console.log("🔗 TCM Database Configuration:");
...
pool.getConnection(function (err, connection) {
  if (err) {
    console.error("❌ TCM Database connection FAILED:", err.message);
    console.error("   Error code:", err.code);
    console.error("   SQL State:", err.sqlState);
  } else {
    console.log("✅ TCM Database connection pool established successfully");

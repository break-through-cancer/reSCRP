...
console.log("🔗 GastricTME Database Configuration:");
...
pool.getConnection(function (err, connection) {
  if (err) {
    console.error("❌ GastricTME Database connection FAILED:", err.message);
    console.error("   Error code:", err.code);
    console.error("   SQL State:", err.sqlState);
  } else {
    console.log("✅ GastricTME Database connection pool established successfully");
